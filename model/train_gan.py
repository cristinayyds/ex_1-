...
def train(args):
    ...
    while epoch < args.epochs:
        ...
        for i, real_images in enumerate(dataloader):
            ...
            z = torch.FloatTensor(np.random.normal(0, 1, (real_images.shape[0], args.latent_dim))).to(device)
            ...
            if epoch % args.sample_interval == 0 and i % (len(dataloader)/5) == 0:
                save_image(gen_imgs.data[0,0], "image/{}_{}.png".format(str(epoch).zfill(len(str(args.epochs))),
